...
class Persona{
    ...
    public function Guardar($nombres, $apellidos, $fechaNacimiento, $direccion, $telefono){
        $conexion = new Conexion();
        $stmt = $conexion->prepare("INSERT INTO persona (nombres, apellidos, fechaNacimiento, direccion, telefono ) 
                                    VALUES (:nombres, :apellidos, :fechaNacimiento, :direccion, :telefono);");
        ...
        if($stmt->execute()){
            ...
            return "Error: se ha generador un error al guardar la informacion";
        }
    }
    ...
    public function Eliminar($idPersona){
        ...
        if($stmt->execute()){
            ...
            return "Error: se ha generador un error al eliminar la informacion";
        }
    }
}
