...
function Guardar(){
    $.ajax({
        ...
        if(response == "OK"){
            MostrarAlerta("Exito!", "Datos guardados con éxito", "success");
        }else{
...
function Modificar(){
    $.ajax({
        ...
        if(response == "OK"){
            MostrarAlerta("Exito!", "Datos actualizados con éxito", "success");
        } else {
            MostrarAlerta("Error!", response, "error");
        }
        Limpiar();
...
function Eliminar(idPersona){
   $.ajax({
        ...
        if(response == "OK"){
            MostrarAlerta("Exito!", "Datos eliminados con éxito", "success");
        }else{
            MostrarAlerta("Error!", response, "error");
        }
        Consultar();
...
function Validar(){
    ...
    if(nombres == "" || apellidos == "" || direccion == "" || fechaNacimiento == "" || telefono == ""){
        return false;
    }
    return true;
}
